...
export const Route = createFileRoute("/handwerkerservice-varel")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.verlegt-verschraubt.de/handwerkerservice-varel" },
    ...
    links: [{ rel: "canonical", href: "https://www.verlegt-verschraubt.de/handwerkerservice-varel" }],
    scripts: [
      jsonLdScript([
        webPageNode({ url: "https://www.verlegt-verschraubt.de/handwerkerservice-varel", name: 'Handwerkerservice in Varel', description: 'Bodenverlegung, Küchenmontage und Entrümpelung in Varel – Verlegt & Verschraubt aus Wilhelmshaven.' }),
        serviceNode({
          url: "https://www.verlegt-verschraubt.de/handwerkerservice-varel",
        ...
        breadcrumbNode([
          ...
          { name: 'Handwerkerservice in Varel', url: "https://www.verlegt-verschraubt.de/handwerkerservice-varel" },
        ]),
