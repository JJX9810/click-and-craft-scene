...
export const Route = createFileRoute("/entruempelung-entsorgung-in-wilhelmshaven")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Entrümpelung Wilhelmshaven – Festpreis, diskret & besenrein" },
      { name: "twitter:description", content: "Wohnungs-, Keller- und Dachbodenräumung, Sperrmüllentsorgung und komplette Haushaltsauflösung in Wilhelmshaven & Umgebung. Festpreis nach Besichtigung, besenreine Übergabe." },
