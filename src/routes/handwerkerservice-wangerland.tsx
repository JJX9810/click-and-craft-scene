...
export const Route = createFileRoute("/handwerkerservice-wangerland")({
  ...
  head: () => ({
    ...
    scripts: [
      jsonLdScript([
        webPageNode({ url: "https://www.verlegt-verschraubt.de/handwerkerservice-wangerland", name: 'Handwerkerservice im Wangerland', description: 'Bodenverlegung, Küchenmontage und Entrümpelung im Wangerland – Verlegt & Verschraubt aus Wilhelmshaven.' }),
        serviceNode({
          url: "https://www.verlegt-verschraubt.de/handwerkerservice-wangerland",
        ...
        breadcrumbNode([
          ...
          { name: 'Handwerkerservice im Wangerland', url: "https://www.verlegt-verschraubt.de/handwerkerservice-wangerland" },
        ]),
