...
export const Route = createFileRoute("/partner")({
  ...
  head: () => ({
    ...
    scripts: [
      jsonLdScript([
        webPageNode({ url: "https://www.verlegt-verschraubt.de/partner", name: 'Partner – Verlegt & Verschraubt', description: 'Partner und Kooperationen von Verlegt & Verschraubt.' }),
        breadcrumbNode([
          { name: "Startseite", url: "https://www.verlegt-verschraubt.de/" },
          { name: 'Partner', url: "https://www.verlegt-verschraubt.de/partner" },
        ]),
      ]),
    ],
  }),
