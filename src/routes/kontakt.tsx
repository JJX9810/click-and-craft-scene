...
export const Route = createFileRoute("/kontakt")({
  ...
  head: () => ({
    ...
    scripts: [
      jsonLdScript([
        webPageNode({ url: "https://www.verlegt-verschraubt.de/kontakt", name: 'Kontakt – Verlegt & Verschraubt Wilhelmshaven', description: 'Anfrage starten: Telefon, E-Mail oder Formular. Antwort in der Regel innerhalb von 24 Stunden.' }),
        breadcrumbNode([
          { name: "Startseite", url: "https://www.verlegt-verschraubt.de/" },
          { name: 'Kontakt', url: "https://www.verlegt-verschraubt.de/kontakt" },
        ]),
      ]),
    ],
  }),
