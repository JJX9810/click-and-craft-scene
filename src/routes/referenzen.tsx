...
export const Route = createFileRoute("/referenzen")({
  ...
  head: () => ({
    ...
    scripts: [
      jsonLdScript([
        webPageNode({ url: "https://www.verlegt-verschraubt.de/referenzen", name: 'Referenzen – Verlegt & Verschraubt', description: 'Ausgewählte Projekte und Referenzen aus Wilhelmshaven und Umgebung.' }),
        breadcrumbNode([
          { name: "Startseite", url: "https://www.verlegt-verschraubt.de/" },
          { name: 'Referenzen', url: "https://www.verlegt-verschraubt.de/referenzen" },
        ]),
      ]),
    ],
  }),
