...
export const Route = createFileRoute("/datenschutz")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image:alt", content: "Datenschutzerklärung von Verlegt & Verschraubt Handwerkerservice Wilhelmshaven" },
      ...
      { name: "twitter:image:alt", content: "Datenschutzerklärung von Verlegt & Verschraubt Handwerkerservice Wilhelmshaven" },
