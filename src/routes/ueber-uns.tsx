...
export const Route = createFileRoute("/ueber-uns")({
  ...
  head: () => ({
    ...
    scripts: [
      jsonLdScript([
        webPageNode({ url: "https://www.verlegt-verschraubt.de/ueber-uns", name: 'Über uns – Verlegt & Verschraubt', description: 'Über Verlegt & Verschraubt Handwerkerservice – Inhaber Justus Brosch aus Wilhelmshaven.' }),
        breadcrumbNode([
          { name: "Startseite", url: "https://www.verlegt-verschraubt.de/" },
          { name: 'Über uns', url: "https://www.verlegt-verschraubt.de/ueber-uns" },
        ]),
      ]),
    ],
  }),
